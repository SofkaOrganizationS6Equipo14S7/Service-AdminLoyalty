...
-- Version: 1.0
-- Description: Tabla para almacenar API Keys de cada ecommerce
...
COMMENT ON TABLE api_keys IS 'API Keys para autenticación de ecommerces';
COMMENT ON COLUMN api_keys.id IS 'Identificador único de la API Key';
COMMENT ON COLUMN api_keys.key_string IS 'La clave completa en formato UUID v4';
