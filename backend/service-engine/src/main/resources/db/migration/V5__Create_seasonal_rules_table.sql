-- Tabla de Reglas de Temporada (Seasonal Rules) - Réplica
-- Service-Engine sincroniza desde Service-Admin via RabbitMQ
-- Misma estructura que loyalty_admin pero sin constraints de FK (datos no persistentes)
