...
description: Implementa un feature completo en el frontend. Requiere spec con status APPROVED en .opencode/specs/.
...
## Prerequisitos
1. Leer spec: `.opencode/specs/<feature>.spec.md` — sección 2.3 (componentes, páginas, hooks)
2. Leer stack: `.opencode/instructions/frontend.instructions.md`
3. Leer arquitectura: `.opencode/instructions/frontend.instructions.md`
...
- Auth state: consumir SÓLO desde el hook/store de auth del proyecto
