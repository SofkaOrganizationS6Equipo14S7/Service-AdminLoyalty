...
description: Implementa un feature completo en el backend Spring Boot. Requiere spec con status APPROVED en .opencode/specs/.
...
2. Leer stack y arquitectura: `.opencode/instructions/backend.instructions.md`
3. Leer referencia de patrones: `.opencode/skills/implement-backend/patterns.java`
...
## Reglas
Ver `.opencode/instructions/backend.instructions.md` — DTOs como Records, Virtual Threads, BigDecimal, Flyway.
