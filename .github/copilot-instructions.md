...
| Documento | Ruta |
|---|---|
| Lineamientos de Desarrollo | `.github/docs/guidelines/dev-guidelines.md` |
| Lineamientos QA | `.github/docs/guidelines/qa-guidelines.md` |
...
| **Technical Architecture (LOYALTY)** | `.github/docs/guidelines/technical-architecture.md` |
