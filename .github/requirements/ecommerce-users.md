...
**When** el ADMIN crea un perfil de usuario asociado a ese ecommerce  
...
### Scenario: Crear usuario para ecommerce
...
- **Auth:** JWT con claim `ecommerce_id` para usuarios no-ADMIN.
- **Stack:** Java 21 + Spring Boot 3.x.
- **Validación:** No permitir crear usuarios sin asignar un ecommerce válido.
- **ADMIN:** Tiene acceso a todos los ecommerce, no tiene restricción de `ecommerce_id`.
